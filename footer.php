    ...
    <div class="row">
        <div class="col-lg-4 col-sm-12">
            <h2 class="text-white text-center footerHeadline">Navigation</h2>
                <div class="col-12">
                    <a href="index.php" class="footerLink text-center"><p class="text-center text-white footerLink">Klik og Hent</p></a>
        ...
        <div class="col-lg-4 col-sm-12">
            ...
            <div class="col-12">
                ...
                <a href="https://goo.gl/maps/6oNiYcTkb5aeCtw29" target="_blank" class="footerContact text-center footerContact"><p class="text-center text-white footerContact"><i class="fas fa-map-marker-alt footerIcon"></i>Moseholm 1, 4180 Sorø</p></a>
            </div>
        </div>
        <div class="col-lg-4 col-sm-12">
